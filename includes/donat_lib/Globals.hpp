...
inline float MIDDLE_LINE_POINT_SIZE = 8;
inline float MIDDLE_LINE_POINT_GAB = 8;

inline float PADDLE_WIDTH = 8;
inline float PADDLE_HEIGHT = 56;
...
inline float IMPACT_VERTICAL_SPEED = 400;
